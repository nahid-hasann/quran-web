        ...
        if (id) {
            fetch(`https://api.alquran.cloud/v1/surah/${id}/editions/quran-uthmani,en.sahih`)
                ...
                .then((data) => {
                    ...
                    setSurah({ ...data.data[0], ayahs: combined });
                });
        }
    }, [id]);
        ...
        <div className="max-w-4xl mx-auto p-4 md:p-10 pb-20">
            ...
            <div className="space-y-8">
                {surah.ayahs.map((ayah: any) => (
                    <div key={ayah.numberInSurah} className="p-8 bg-[#1a1a1a] rounded-2xl border border-gray-800 hover:border-green-900/30 transition-all">
                            ...
                            <div className="flex justify-between items-start gap-6">
                                <div className="flex flex-col items-center gap-4">
                                    ...
                                    <button
                                        ...
                                        className={`w-14 h-14 flex items-center justify-center rounded-full text-2xl transition-all ${playingId === ayah.number ? "bg-green-600 text-white" : "bg-gray-800 text-gray-400"
                                            }`}
                                    >
