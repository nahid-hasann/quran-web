...
// Global variable to track audio across re-renders
...
export default function SurahPage() {
    ...
    useEffect(() => {
        ...
        loadSettings();
        // Custom event check korchi jeta SettingsPanel theke trigger hobe
        window.addEventListener("settings_changed", loadSettings);
        window.addEventListener("storage", loadSettings); // Default storage change check
    ...
    // 2. Audio Play/Pause/Resume Logic
    ...
    if (!surah) return <div className="p-10 text-center text-gray-400 font-bold uppercase tracking-widest">Loading Surah...</div>;
        ...
        <div className="max-w-4xl mx-auto p-4 md:p-8 pb-20">
            ...
            <div className="space-y-6">
                {surah.ayahs.map((ayah) => (
                    <div key={ayah.numberInSurah} className="p-6 md:p-10 bg-[#1a1a1a] rounded-2xl border border-gray-800 hover:border-green-900/30 transition-all shadow-md">
                        <div className="flex flex-col space-y-8">
                            <div className="flex justify-between items-center gap-6">
                                {/* Left side: Number and Audio Toggle */}
                                <div className="flex flex-col items-center gap-4">
                                    ...
                                    <button
                                        ...
                                        className={`w-12 h-12 flex items-center justify-center rounded-full transition-all shadow-lg text-xl ${playingId === ayah.number
                                ...
                                <p
                                    className={`text-right leading-loose flex-1 ${settings.font}`}
                            ...
                            {/* Translation Text */}
                            <p
                                className="text-gray-300 border-t border-gray-800 pt-6 font-light"
