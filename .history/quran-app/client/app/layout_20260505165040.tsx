  ...
  return (
    <html lang="en" className="dark">
      <body className={`${inter.className} bg-[#121212] text-white flex h-screen overflow-hidden`}>
        ...
        {/* 1. Left Icon Sidebar - Tablet/Desktop e thakbe, Mobile e bottom bar o kora jay kintu ekhane responsive icon bar rakhchi */}
        ...
        {/* 2. Middle Surah Sidebar - Tablet/Desktop e thakbe. 
            Note: Mobile er jonno tumi eita drawer hisebe handle korte paro pore. */}
